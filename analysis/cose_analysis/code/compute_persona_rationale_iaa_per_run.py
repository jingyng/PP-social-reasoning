...
def main():
    ...
    per_run_csv = out_dir / "persona_rationale_iaa_cose_per_run.csv"
    ...
    averaged_csv = out_dir / "persona_rationale_iaa_cose_averaged.csv"
    ...
    print("\nPersona rationale inter-annotator agreement analysis for CoSE completed!")
