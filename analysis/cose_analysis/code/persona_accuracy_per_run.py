...
def main():
    print("Computing persona accuracy for CoSE dataset...")
    ...
    per_run_csv = out_dir / "persona_accuracy_cose_per_run.csv"
    ...
    averaged_csv = out_dir / "persona_accuracy_cose_averaged.csv"
    ...
    matched_csv = out_dir / "persona_accuracy_cose_matched_averaged.csv"
    ...
    print("\nPersona accuracy analysis for CoSE completed!")
