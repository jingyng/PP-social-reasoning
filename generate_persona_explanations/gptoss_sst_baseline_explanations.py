...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/gptoss_sst_baseline.log", mode='a', encoding='utf-8'),
    ],
)
...
results_dir = "../datasets/results_gpt_oss_120b_sst_r3"
os.makedirs(results_dir, exist_ok=True)
output_file = os.path.join(results_dir, "baseline_gpt_oss_120b_sst.jsonl")
...
for q_idx, item in enumerate(questions):
    ...
    baseline_pid = f"{question_id}___gpt_oss_120b_sst_baseline"
    result = {
