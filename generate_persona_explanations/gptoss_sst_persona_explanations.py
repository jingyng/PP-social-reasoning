...
default_results_dir = "../datasets/results_gpt_oss_120b_sst_r3"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/gptoss_persona_sst.log", mode='a', encoding='utf-8'),
    ],
)
    ...
    with output_path.open("r", encoding="utf-8") as f:
        for line in f:
            ...
            if pid:
                ...
                done.add(re.sub(r"_{2,}(?=\d)", "___", pid))
    return done
...
parser = argparse.ArgumentParser(description="Generate GPT-OSS SST persona explanations, skipping existing entries.")
parser.add_argument(
    "--results-dir",
