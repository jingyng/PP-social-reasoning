...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/mistral_persona_cose.log", mode='a', encoding='utf-8')  # Log to logs folder
    ]
)
...
def _normalize_persona_id(pid: str) -> str:
    ...
    - Any run of 2 or more underscores immediately before the age digits becomes exactly 3.
      Examples: QID123__25_m_b -> QID123___25_m_b; QID123____25_m_b -> QID123___25_m_b
    """
    try:
...
parser = argparse.ArgumentParser(description="Generate Mistral COSE persona explanations, skipping existing entries.")
parser.add_argument(
    "--results-dir",
    default="../datasets/results_mistral_medium_cose_r2/",
