...
default_results_dir = "../datasets/results_mistral_medium_sst_r3"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/mistral_persona_sst.log", mode='a', encoding='utf-8'),
    ],
)
...
parser = argparse.ArgumentParser(description="Generate Mistral SST persona explanations, skipping existing entries.")
parser.add_argument(
    "--results-dir",
