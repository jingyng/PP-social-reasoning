...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/qwen_cose_baseline.log", mode='a', encoding='utf-8'),
    ],
)
...
results_dir = "../datasets/results_qwen3_32b_cose_r3"
os.makedirs(results_dir, exist_ok=True)
output_file = os.path.join(results_dir, "baseline_qwen3_32b_cose.jsonl")
...
for q_idx, item in enumerate(questions):
    ...
    baseline_pid = f"{question_id}___qwen3_32b_cose_baseline"
    result = {
