...
DEFAULT_RESULTS_DIR = "../datasets/results_qwen3_32b_500_r3"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("../logs/qwen_persona_prompting.log", mode='a', encoding='utf-8'),
    ],
)
...
parser = argparse.ArgumentParser(description="Generate Qwen HateXplain persona explanations, skipping existing entries.")
parser.add_argument(
    "--results-dir",
